...
public class ExemploStreamAPI {
	...
	public static void main(String[] args) {
		...
		System.out.println("Uma nova coleção com a quantidade de letras: "+estudantes.stream().map(estudante -> 
		...
		System.out.println("Algum elemento com a minusculo no nome ? "+estudantes.stream().anyMatch((elemento) -> elemento.contains("a")));
		
		// Retorna true se nenhum dos elementos possuem a letra a minuscula no nome
